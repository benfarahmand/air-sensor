...
class MQ2PPM():
    ...
    CALIBRATION_SAMPLE_INTERVAL  = 500      # define the time interval(in milliseconds) between each samples in the
                                            # cablibration phase
    READ_SAMPLE_INTERVAL         = 50       # define the time interval(in milliseconds) between each samples in
